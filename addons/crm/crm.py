...
class crm_case_stage(osv.osv):
    ...
    _columns = {
        ...
        #KGB to int'probability': fields.float('Probability (%)', required=True, help="This percentage depicts the default/average probability of the Case for this stage to be a success"),
        'probability': fields.integer('Probability (%)', required=True, help="This percentage depicts the default/average probability of the Case for this stage to be a success"),
    ...
    _defaults = {
        ...
        #KGB to int'probability': lambda *args: 0.0,
        'probability': lambda *args: 0,
    }
...
class crm_base(object):
    ...
    def case_open(self, cr, uid, ids, *args):
        ...
        for case in cases:
            ...
            if not case.user_id:
                data['user_id'] = uid
            self.write(cr, uid, [case.id], data) #KGB[]
