...
class crm_phonecall(crm_base, osv.osv):
    ...
    def schedule_another_phonecall(self, cr, uid, ids, schedule_time, call_summary, \
        ...
        for call in self.browse(cr, uid, ids, context=context):
            ...
            vals = {
                    ...
                    'opportunity_id': call.opportunity_id and call.opportunity_id.id or False,  # KGB
            }
    ...
    #KGB prob 0
    def convert_opportunity(self, cr, uid, ids, opportunity_summary=False, partner_id=False, planned_revenue=0.0, probability=0, context=None):
        partner = self.pool.get('res.partner')
        address = self.pool.get('res.partner.address')
