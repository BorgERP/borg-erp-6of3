...
class crm_lead(crm_case, osv.osv):
    ...
    _columns = {
        ...
        #KGB back to orig 'partner_address_id': fields.many2one('res.partner.address', 'Partner Contact', domain="[('active','=',True)]"),
        #kgb because of update of modules 'probability': fields.float('Probability (%)', group_operator="avg"),
        'probability': fields.integer('Probability (%)', group_operator="avg"),
    ...
    def case_cancel(self, cr, uid, ids, *args):
        ...
        #probability>int self.write(cr, uid, ids, {'probability' : 0.0})
        self.write(cr, uid, ids, {'probability' : 0})
        return res
    ...
    def case_reset(self, cr, uid, ids, *args):
        ...
        #probability>int self.write(cr, uid, ids, {'stage_id': False, 'probability': 0.0})
        self.write(cr, uid, ids, {'stage_id': False, 'probability': 0})
        return res
    ...
    def case_mark_won(self, cr, uid, ids, *args):
        ...
        res = super(crm_lead, self).case_close(cr, uid, ids, *args)
        #probability>int self.write(cr, uid, ids, {'probability' : 0.0})
        self.write(cr, uid, ids, {'probability' : 100})
        for l in self.browse(cr, uid, ids):
    ...
    def _lead_set_partner(self, cr, uid, lead, partner_id, context=None):
        ...
        if partner_id:
            ...
            res = lead.write({'partner_id' : partner_id,
                              # KGB 'partner_address_id': contact_id
                              }, context=context)
