...
class crm_lead_report(osv.osv):
    ...
    _columns = {
        ...
        #kgb to int'probability': fields.float('Probability',digits=(16,2),readonly=True, group_operator="avg"),
        'probability': fields.integer('Probability',readonly=True, group_operator="avg"),
