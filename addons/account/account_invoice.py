...
class account_invoice(osv.osv):
    ...
    _columns = {
        ...
        #KGB temp
        'ccurrency_rate': fields.float('Force Exchange Rate', digits=(15,8), required=False, readonly=True, states={'draft': [('readonly', False)]},
        ...
        for il in iml:
            if il['account_analytic_id']:
                ...
                il['analytic_lines'] = [(0,0, {
                    ...
                    'amount': cur_obj.compute(cr, uid, inv.currency_id.id, company_currency, il['price'],
    ...
    def action_move_create(self, cr, uid, ids, context=None):
        ...
        for inv in self.browse(cr, uid, ids, context=context):
            ...
            #KGB I enabled it again but refund wizard bites
    ...
    def move_line_get(self, cr, uid, invoice_id, context=None):
        ...
        for line in inv.invoice_line:
            ...
            for tax in tax_obj.compute_all(cr, uid, line.invoice_line_tax_id,
                ...
                #KGB temp
                res[-1]['tax_amount'] = cur_obj.compute(cr, uid, inv.currency_id.id, company_currency, tax_amount,
                                                         context={'date': inv.date_invoice,
                                                                  'force_currency_inv_rate': inv.ccurrency_rate,
                                                                  })
        return res
