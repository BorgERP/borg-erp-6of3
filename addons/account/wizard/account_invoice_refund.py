        ...
        for form in self.browse(cr, uid, ids, context=context):
            ...
            for inv in inv_obj.browse(cr, uid, context.get('active_ids'), context=context):
                ...
                inv_obj.write(cr, uid, [refund.id], {'date_due': date,})
                                                #'check_total': inv.amount_total})   #KGB was inv.check_total #TODO make bug report
                inv_obj.button_compute(cr, uid, refund_id)
                inv_obj.write(cr, uid, [refund.id], {'check_total': inv_obj.browse(cr, uid, refund_id[0]).amount_total 
                                                     })   #KGB was inv.check_total #TODO make bug report
