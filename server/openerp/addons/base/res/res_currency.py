...
class res_currency(osv.osv):
    ...
    _columns = {
        ...
        'rate': fields.function(_current_rate, string='Current Rate', digits=(16,8),
            help='The rate of the currency to the currency of rate 1.'),
        'rate_ids': fields.one2many('res.currency.rate', 'currency_id', 'Rates'),
        'accuracy': fields.integer('Computational Accuracy'),
        'rounding': fields.float('Rounding Factor', digits=(16,8)),
...
class res_currency_rate(osv.osv):
    ...
    _columns = {
        ...
        'rate': fields.float('Rate', digits=(16,8), help='The rate of the currency to the currency of rate 1'),
