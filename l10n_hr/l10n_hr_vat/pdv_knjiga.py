...
class l10n_hr_pdv_knjiga_stavka(osv.osv):
    ...
    _columns = {
        ...
        'reconcile_id'     : fields.many2one('account.move.reconcile', 'Reconcile ID'),
        'reconcile_move_id': fields.many2one('account.move', 'Preknjizavanje kod zatvaranja'),
        'invoice_partner_street': fields.related('invoice_id','partner_id','address', 'street', type='char', readonly=True, size=64, relation='account.invoice', store=True, string='Adresa'),
...
class account_tax_code(osv.osv):
    ...
    _columns = {
        'l10n_hr_pdv_knjiga_id': fields.many2one('l10n_hr_pdv.knjiga','Porezne knjige URA,IRA'),
    }    
account_tax_code()
